  ...
  return (
    <div className="min-h-screen bg-neutral-50 font-sans text-neutral-900 flex flex-col antialiased">
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen transition-all duration-200 flex-1">
        {/* Top Header */}
        <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-sm border-b border-neutral-200 h-14 flex md:grid md:grid-cols-[1fr_minmax(280px,460px)_1fr] lg:grid-cols-[1fr_minmax(320px,520px)_1fr] items-center justify-between gap-3 px-4 sm:px-6 shrink-0">
          ...
          <div className="hidden md:flex items-center justify-center w-full min-w-0">
            <div
          ...
          <div className="flex items-center justify-end gap-2 sm:gap-2.5 shrink-0 ml-auto md:ml-0">
