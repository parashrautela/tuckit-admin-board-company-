...
export const BookingDetailModal: React.FC<BookingDetailModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      <DialogContent className="sm:max-w-4xl p-0 overflow-hidden border-neutral-200 shadow-2xl rounded-2xl bg-white focus:outline-none max-h-[90vh] flex flex-col">
        ...
        {/* ── Modal Header ── */}
        <div className="p-6 pb-4 border-b border-neutral-100 flex items-start justify-between gap-4 bg-white shrink-0 pr-14">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge variant="outline" className="font-mono text-xs font-semibold text-neutral-700 bg-neutral-50 border-neutral-200 px-2 py-0.5">
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar flex flex-col gap-6 bg-white">
          {/* ── 1. Top Section: 6 Info Cards + Total Amount Payable Card ── */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            {/* Left 2 cols: 6 Metadata Cards in 2x3 grid */}
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* Customer Name */}
              <Card className="border border-neutral-200/80 bg-neutral-50/40 shadow-2xs">
            ...
            {/* Right col: High-Emphasis Payable Card (Consistent Brand Palette) */}
            <Card className="border border-neutral-800 bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-950 text-white shadow-md flex flex-col justify-between overflow-hidden">
              <CardContent className="p-5 flex flex-col justify-between h-full">
                <div>
                  ...
                  <div className="flex items-baseline gap-2 mt-1.5">
                    ...
                    <span className="text-xs text-neutral-400 font-medium">Incl. GST</span>
                  </div>
                </div>

                <div className="flex items-center justify-between pt-4 border-t border-neutral-800 mt-5 text-xs">
                  <div>
                    <span className="text-[11px] font-medium text-neutral-400 block uppercase tracking-wider">Paid Amount</span>
                    <span className="text-base font-bold font-mono text-emerald-400 mt-0.5 block">
                      ₹{paidAmount.toFixed(2)}
                    </span>
                  </div>
                  <div className="text-right">
                    <span className="text-[11px] font-medium text-neutral-400 block uppercase tracking-wider">Pending</span>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <Card className="border border-neutral-200/80 bg-neutral-50/40 shadow-2xs">
                <CardContent className="p-3.5 flex items-center gap-3">
                  <div className="size-8 rounded-lg bg-primary-50 text-primary-600 flex items-center justify-center shrink-0">
          ...
          <Card className="border border-neutral-200/80 bg-neutral-50/20 shadow-2xs">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Badge variant="outline" className="text-[10px] font-bold text-neutral-600 font-mono bg-neutral-100 border-neutral-200">
                {logs.length} LOGS
              </Badge>
            </div>
