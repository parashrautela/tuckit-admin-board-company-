    ...
    <div className="flex flex-col gap-6 font-sans">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card className="border border-neutral-200 shadow-2xs">
          <CardContent className="p-4 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Total Stations</span>
              <Layers className="size-4 text-zinc-400" />
            </div>
            <div className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-900 mt-1">{stations.length}</div>
            <span className="text-xs text-zinc-500">3 Active / 1 Maintenance</span>
          </CardContent>
        </Card>
        ...
        <Card className="border border-neutral-200 shadow-2xs">
          <CardContent className="p-4 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Total Capacity</span>
            ...
            <span className="text-xs text-zinc-500">{totalOccupied} Currently Occupied</span>
          </CardContent>
        </Card>
        ...
        <Card className="border border-neutral-200 shadow-2xs">
          <CardContent className="p-4 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Active Bookings</span>
            ...
            <span className="text-xs text-zinc-500">Advance mobile bookings</span>
          </CardContent>
        </Card>
        ...
        <Card className="border border-neutral-200 shadow-2xs">
          <CardContent className="p-4 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Solar Yield</span>
            ...
            <span className="text-xs text-zinc-500">Clean off-grid power</span>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filtered.map(s => (
          <Card key={s.id} className="hover:border-zinc-300 transition-all flex flex-col justify-between border border-neutral-200 shadow-2xs">
            <CardHeader className="p-4 sm:p-5 pb-3 border-b border-zinc-100 flex flex-row items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold font-mono text-zinc-900 bg-zinc-100 px-2 py-0.5 rounded border border-zinc-200">
                  {s.code}
                </span>
                <Badge variant="secondary" size="sm" className="font-mono text-xs text-zinc-700">
                  {s.type.replace('_', ' ')}
                </Badge>
              </div>
            ...
            <CardContent className="p-4 sm:p-5 pt-3 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-3 gap-2 p-3 bg-zinc-50 rounded-lg border border-zinc-200/80 text-xs">
                <div className="flex items-center gap-2">
                  <BatteryCharging className="size-4 text-zinc-500" />
                  <div>
                    <div className="text-xs text-zinc-500 uppercase font-bold">Battery</div>
                    <div className="font-semibold font-mono text-zinc-900 text-xs">{s.batteryLevel}%</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs text-zinc-500 uppercase font-bold">Solar</div>
                    <div className="font-semibold font-mono text-zinc-900 text-xs">{s.solarWatts} W</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs text-zinc-500 uppercase font-bold">Signal</div>
                    <div className="font-semibold font-mono text-zinc-900 text-xs">{s.signalDbm} dBm</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1 text-xs">
                <div className="flex justify-between font-medium">
                  <span className="text-zinc-600">Locker Occupancy</span>
              ...
              <div className="pt-2.5 border-t border-zinc-100 flex items-center justify-between">
                <span className="text-xs text-zinc-500 font-mono">Heartbeat: {s.lastHeartbeat}</span>
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => handleRebootStation(s.code)}
                  className="h-8 px-3 text-xs font-semibold border-zinc-200 text-zinc-800 hover:bg-zinc-50"
                >
